...
* [Ⅷ. 파이썬과 인공지능](#ⅷ-파이썬과-인공지능)
  * [파이썬과 인공지능](#week-8-1-파이썬과-인공지능)
  * [인공지능 프로젝트 사례](#week-8-2-인공지능-프로젝트-사례)
# Ⅴ. 제어 문장 2  
...
## WEEK 8-2 인공지능 프로젝트 사례
* 식자재 사물 인식을 통한 맞춤 요리 추천 모듈 구현
* 얼굴인식 기능 => 비전 이용
## Object Detection
* 이미지나 동영상에서 사람, 동물, 차량 등 의미있는 객체의 종류와 그 위치를 정확하게 찾기 위한 computer vision기술 ex)cctv등
## 자연어 처리기술
* 신문기사의 내용을 요약하고 싶다면?
  * 특정 신문사의 기사를 크롤링하여 db에 저장 후 .txt로 저장해서 각각 알고리즘을 적용해서 요약 가능
## 챗봇 프로그램
* 음성데이터를 문자로 바꾸고 특정 분야의 전문 지식을 다시 음성으로 대답함.
## 무인 자동차
* rc카를 이용해서 운전을 할 때 많은 기능 필요
* 라즈베이파이라는 작은 컴퓨터를 조립하여 명령을 받아서 움직이도록 해야함
* 영상정보를 넣어서 분석을 하여(딥러닝) 길을 분류하여 방향 명령을 내린다.
